    ...
    return (
        <div className='max-w-screen mx-auto xl:px-24 px-4'>
            <div className='bg-appWhite-300 pt-40 px-4 lg:px-16'>
                <div className='my-jobs-container mb-2'>
                    <h1 className='text-center p-4'>Minhas vagas</h1>
                    <div className='search-box p-2 text-center'>
                        ...
                        <button className='bg-appBlue-500 text-white font-semibold px-8 py-2 rounded-sm mb-4' onClick={handleSearch}>Pesquisar</button>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div className="rounded-t mb-0 px-4 py-3 border-0">
                            <div className="flex flex-wrap items-center">
                                <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                                    <h3 className="font-semibold text-base text-blueGray-700">Todas as vagas</h3>
                                </div>
                        ...
                        <div className="block w-full overflow-x-auto">
                            <table className="items-center bg-transparent w-full border-collapse ">
                                ...
                                {
                                    isLoading ? (<div className='flex items-center justify-center h-20'><p>Carregando...</p></div>) : (
...

                                        {
                                            ...
                                            <tr key={index}>
                                                ...
                                                <td
                                                    className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                    <i className="fas fa-arrow-up text-emerald-500 mr-4"></i>
                                                    <button><Link to={`/edit-job/${job?._id}`}>Editar</Link></button>
                                                </td>
                                                <td
                                                    className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
