...
const Salary = ({handleChange, handleClick}) => {
    return (
        <div>
            ...
            <div className='mb-4'>
                <Button onClickHandler={handleClick} value="" title="Hora"/>
                <Button onClickHandler={handleClick} value="Monthly" title="Mês"/>
                <Button onClickHandler={handleClick} value="Yearly" title="Ano"/>
            </div>

            <div>

                <label className="sidebar-label-container">
                    <input type="radio" name='test2' id='test-3' value="" onChange={handleChange} />
